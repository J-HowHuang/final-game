...
Button back("back", MAP_WIDTH / 2 + 300, MAP_HEIGHT / 2 - 275, 172, 64);
Button tutorialBg("tutorialBackground", 50, 65, 900, 648);
Button close("close_1", 0, 0, 1000, 720);
Button title("title",  40 , MAP_HEIGHT / 2 + 100 , 1000 , 150);
