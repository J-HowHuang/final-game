...
#define START_BUTTON_LEFT MAP_WIDTH / 2 - 86
#define START_BUTTON_RIGHT  MAP_WIDTH / 2 + 86
#define START_BUTTON_UP  MAP_HEIGHT / 2 + 32
#define START_BUTTON_BOT  MAP_HEIGHT / 2 - 32
//#define TUTORIAL_BUTTON_LEFT MAP_WIDTH / 2 - 172
//#define TUTORIAL_BUTTON_RIGHT  MAP_WIDTH / 2 + 172
//#define TUTORIAL_BUTTON_UP  MAP_HEIGHT / 2 + 
